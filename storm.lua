...
--v function()
function storm_of_chaos.init()
    local self = {}
    setmetatable(self, {
        __index = storm_of_chaos
    }) --# assume self: STORM_OF_CHAOS

    self.game_phase = cm:get_saved_value("storm_of_chaos_game_phase") or 0
    self.locations = {} --:map<string, SOC_LOCATION>
